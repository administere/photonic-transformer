...
DOI: \href{https://doi.org/10.5281/zenodo.20690521}{10.5281/zenodo.20690521}\\
...
All 25 verification items pass.

\subsection{System-Level Impact}

At $D=2048$, a single processor delivers 9,651$\times$ the energy
efficiency of an NVIDIA H100 GPU, consuming 875\,W while providing
the equivalent throughput of 14,757 H100s (10.3\,MW). A city of one
million inhabitants requires only two such processors (1.3\,kW) for
peak AI inference demand.

Scaling to global industrial AI adoption: assuming a 100$\times$
increase over current AI compute demand (5,000\,TWh/year), the H100
route would consume 17\% of global electricity generation and emit
2,000\,Gt of CO$_2$ annually. The photonic route requires 0.5\,TWh/year
--- 0.002\% of global generation --- rendering AI's energy footprint
a rounding error on the world's electrical grids.

The fundamental advantage is physical, not architectural: a single
photon pulse traverses $D$ sequential modulators, performing $D$
multiply-accumulate operations while expending the energy of one pulse.
Electronics must expend fresh charge for each MAC. This is a
consequence of Maxwell's equations, not an engineering optimization.
